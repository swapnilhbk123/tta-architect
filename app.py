...
# --- 1. AI CONFIGURATION ---
# This pulls the key you will paste into Streamlit's "Advanced Settings > Secrets"
try:
    genai.configure(api_key=st.secrets["GOOGLE_API_KEY"])
    model = genai.GenerativeModel('gemini-pro')
except:
    st.warning("⚠️ API Key not found. Please add GOOGLE_API_KEY to Streamlit Secrets.")
...
with col1:
    ...
    ref_no = st.text_input("Quotation Ref", "CS" + "000000")
...
if st.button("✨ GENERATE PROFESSIONAL PROPOSAL"):
    if not (dest and raw_itinerary and price):
        ...
        with st.spinner("Gemini is rewriting your itinerary into TTA style..."):
            ...
            try:
                ...
                st.error("AI Beautification failed. Using raw notes for PDF.")
